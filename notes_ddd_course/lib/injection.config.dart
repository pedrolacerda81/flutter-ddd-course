...
import 'application/notes/note_watcher/note_watch_bloc.dart';
...
GetIt $initGetIt(
  ...
  gh.lazySingleton<FirebaseFirestore>(() => firebaseInjectableModule.firestor);
  ...
  gh.factory<NoteWatchBloc>(() => NoteWatchBloc(get<INoteRepository>()));
