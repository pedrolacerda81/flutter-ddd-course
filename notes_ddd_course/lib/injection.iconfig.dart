...
import 'package:notes_ddd_course/infrastructure/core/firebase_injectable_module.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:google_sign_in/google_sign_in.dart';
import 'package:notes_ddd_course/infrastructure/auth/firebase_auth_facade.dart';
import 'package:notes_ddd_course/domain/auth/i_auth_facade.dart';
import 'package:notes_ddd_course/infrastructure/notes/note_repository.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  ...
  g.registerLazySingleton<Firestore>(() => firebaseInjectableModule.firestor);
  ...
  g.registerFactory<NoteWatchBloc>(() => NoteWatchBloc(g<INoteRepository>()));
