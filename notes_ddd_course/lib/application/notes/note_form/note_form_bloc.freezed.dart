...
mixin _$NoteFormEvent {
  ...
  Result when<Result extends Object>({
    ...
    @required Result todosChanged(KtList<TodoItemPrimitive> todosList),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result todosChanged(KtList<TodoItemPrimitive> todosList),
    Result saved(),
...
class __$TodosChangedCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_TodosChanged(
      todosList == freezed
          ? _value.todosList
          : todosList as KtList<TodoItemPrimitive>,
    ));
  }
}

class _$_TodosChanged implements _TodosChanged {
  const _$_TodosChanged(this.todosList) : assert(todosList != null);
...
abstract class _TodosChanged implements NoteFormEvent {
  ...
  KtList<TodoItemPrimitive> get todosList;
  _$TodosChangedCopyWith<_TodosChanged> get copyWith;
}
