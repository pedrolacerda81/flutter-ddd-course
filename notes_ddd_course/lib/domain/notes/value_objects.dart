...
import 'package:notes_ddd_course/domain/core/value_transformers.dart';
...
class NoteBody extends ValueObject<String> {
  ...
  factory NoteBody(String input) {
    assert(input != null);
    return NoteBody._(
      validateMaxStringLengh(input, maxLength).flatMap(validateStringNotEmpty),
    );
  }
...
class TodoName extends ValueObject<String> {
  ...
  factory TodoName(String input) {
    assert(input != null);
    return TodoName._(
      validateMaxStringLengh(input, maxLength)
